...
function Actuality() {
    return (
        <div className="w-25% h-80% top-13% left-37.5% absolute font-sans text-white text-center text-3xl md:text-4xl float-left bg-Banner overflow-hidden rounded-2xl">
